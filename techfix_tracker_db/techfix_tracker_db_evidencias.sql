...
CREATE TABLE `evidencias` (
  ...
  `ruta_archivo` varchar(150) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  `fecha_subida` datetime NOT NULL,
  PRIMARY KEY (`id_evidencia`),
  KEY `fk_falla_disp_idx` (`id_falla`),
  CONSTRAINT `fk_falla_disp` FOREIGN KEY (`id_falla`) REFERENCES `fallas_dispositivos` (`id_falla`)
